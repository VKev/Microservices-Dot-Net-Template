...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: redis
          image: 936910352865.dkr.ecr.us-east-1.amazonaws.com/dockerhub/library/redis:alpine
          ports:
            - containerPort: 6379
          env:
            - name: REDIS_PASSWORD
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: rabbit-mq
          image: 936910352865.dkr.ecr.us-east-1.amazonaws.com/dockerhub/library/rabbitmq:3-management
          ports:
            - containerPort: 5672
            - containerPort: 15672
          startupProbe:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: n8n
          image: 936910352865.dkr.ecr.us-east-1.amazonaws.com/dockerhub/n8nio/n8n:latest
          env:
            - name: N8N_HOST
              value: "0.0.0.0"
            - name: N8N_PORT
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: guest-microservice
          image: 936910352865.dkr.ecr.us-east-1.amazonaws.com/vkev2406-infrastructure-khanghv2406-infrastructure-khanghv2406-ecr:Guest.Microservice-latest
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: user-microservice
          image: 936910352865.dkr.ecr.us-east-1.amazonaws.com/vkev2406-infrastructure-khanghv2406-infrastructure-khanghv2406-ecr:User.Microservice-latest
          imagePullPolicy: IfNotPresent
          ports:
            - containerPort: 5002
          env:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: api-gateway
          image: 936910352865.dkr.ecr.us-east-1.amazonaws.com/vkev2406-infrastructure-khanghv2406-infrastructure-khanghv2406-ecr:ApiGateway-latest
          imagePullPolicy: IfNotPresent
          ports:
            - containerPort: 8080
          env:
