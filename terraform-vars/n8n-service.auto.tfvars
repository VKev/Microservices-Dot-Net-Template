services = {
  n8n = {
    ...
    ecs_container_cpu                  = 640
    ecs_container_memory               = 1280
    ...
    ecs_environment_variables = [
      ...
      { name = "N8N_DB_POSTGRESDB_HOST", value = "TERRAFORM_RDS_HOST_USER_N8NDB" },
      { name = "N8N_DB_POSTGRESDB_PORT", value = "TERRAFORM_RDS_PORT_USER_N8NDB" },
      { name = "N8N_DB_POSTGRESDB_DATABASE", value = "TERRAFORM_RDS_DB_USER_N8NDB" },
      { name = "N8N_DB_POSTGRESDB_USER", value = "TERRAFORM_RDS_USERNAME_USER_N8NDB" },
      { name = "N8N_DB_POSTGRESDB_PASSWORD", value = "TERRAFORM_RDS_PASSWORD_USER_N8NDB" },
